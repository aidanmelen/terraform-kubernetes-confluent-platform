...
func TestTerraformConfluentPlatformSinglenodeExample(t *testing.T) {
	...
	expectedControlCenter := map[string]interface{}(map[string]interface{}{"apiVersion": "platform.confluent.io/v1beta1", "kind": "ControlCenter", "metadata": map[string]interface{}{"name": "controlcenter", "namespace": "confluent"}, "spec": map[string]interface{}{"dataVolumeCapacity": "10Gi", "dependencies": map[string]interface{}{"connect": []map[string]interface{}{map[string]interface{}{"name": "connect", "url": "http://connect.confluent.svc.cluster.local:8081"}}, "ksqldb": []map[string]interface{}{map[string]interface{}{"name": "ksqldb", "url": "http://ksqldb.confluent.svc.cluster.local:8088"}}, "schemaRegistry": map[string]interface{}{"url": "http://schemaregistry.confluent.svc.cluster.local:8081"}}, "image": map[string]interface{}{"application": "confluentinc/cp-enterprise-control-center:7.2.0", "init": "confluentinc/confluent-init-container:2.4.0"}, "replicas": 1}})
	expectedSchemaRegistry := map[string]interface{}(map[string]interface{}{"apiVersion": "platform.confluent.io/v1beta1", "kind": "SchemaRegistry", "metadata": map[string]interface{}{"name": "schemaregistry", "namespace": "confluent"}, "spec": map[string]interface{}{"image": map[string]interface{}{"application": "confluentinc/cp-schema-registry:7.2.0", "init": "confluentinc/confluent-init-container:2.4.0"}, "replicas": 1}})
