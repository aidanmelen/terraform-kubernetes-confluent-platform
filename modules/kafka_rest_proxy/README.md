# terraform-kubernetes-confluent-platform/kafka_rest_proxy

Kafka REST Proxy submodule.

## Example

```hcl
module "kafka_rest_proxy" {
  source    = "aidanmelen/kubernetes/confluent-platform//modules/kafka_rest_proxy"
  namespace = "confluent"
  spec      = {
    "dependencies" = {
      "schemaRegistry" = {
...
| Name | Type |
|------|------|
| [kubernetes_manifest.kafka_rest_proxy](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/manifest) | resource |
...
| <a name="input_name"></a> [name](#input\_name) | The name for the CFK component. | `string` | `"kafkarestproxy"` | no |
| <a name="input_namespace"></a> [namespace](#input\_namespace) | The kubernetes namespace for the CFK component. | `string` | `"confluent"` | no |
| <a name="input_spec"></a> [spec](#input\_spec) | The kubernetes spec for the CFK component. | `any` | <pre>{<br>  "dependencies": {<br>    "schemaRegistry": {<br>      "url": "http://schemaregistry.confluent.svc.cluster.local:8081"<br>    }<br>  },<br>  "image": {<br>    "application": "confluentinc/cp-kafka-rest:7.2.0",<br>    "init": "confluentinc/confluent-init-container:2.4.0"<br>  },<br>  "replicas": 1<br>}</pre> | no |
